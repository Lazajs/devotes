...
export default function InputField ({reference, type, holder}: Props) {
  ...
  if (type === 'password') {
    ...
    return (
      <span className="relative">
        <input className='w-full pr-[6rem] bg-primary outline-none border-none h-[6rem] text-text p-medium font-normal text-textWhite' placeholder={holder} type={isVisible ? 'text' : 'password'} ref={reference} />
